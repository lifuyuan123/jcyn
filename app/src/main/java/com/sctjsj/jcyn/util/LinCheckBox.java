...
public class LinCheckBox extends View implements Checkable {
    ...
    public LinCheckBox(Context context) {
        this(context, null);
    }

    public LinCheckBox(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LinCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public LinCheckBox(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setChecked(boolean checked) {
        ...
        invalidate();
        if (mListener != null) {
            mListener.onCheckedChanged(LinCheckBox.this, mChecked);
        }
    }
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(LinCheckBox checkBox, boolean isChecked);
    }
}
